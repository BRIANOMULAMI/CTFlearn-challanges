...
public class Base32 extends BaseNCodec {
        ...
        if (!context2.eof) {
            ...
            if (context2.eof && context2.modulus >= 2) {
                ...
                switch (context2.modulus) {
                    case 2:
                        validateCharacter(MASK_2BITS, context2);
                    ...
                    case 3:
                        ...
                        context2.pos = i13 + 1;
                        ensureBufferSize2[i13] = (byte) ((int) ((context2.lbitWorkArea >> MASK_3BITS) & 255));
                        return;
                    case 4:
                    ...
                    case 7:
                        ...
                        context2.lbitWorkArea >>= MASK_2BITS;
    ...
    private static void validateCharacter(long j, BaseNCodec.Context context) {
        if ((j & context.lbitWorkArea) != 0) {
